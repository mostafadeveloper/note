...
<h1>حذف یاداشت</h1>
<div class="post_cnt">
بعد از اتکمام کار بر روی دکمه حذف کلیک کنید
<br/>
<form action="./delete_note_process.php" method="POST" target="_blank">
<input type="text" name="note_id" placeholder=" یاداشت ID"  title="ای دی ها در صفحه یاداشت ها میباشند" required="required"/><br/>
